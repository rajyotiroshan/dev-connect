...
router.put('/like/:post_id', auth, async (req, res) => {
  try {
    ...
    /**
     * another logic
     * check if userid exist in the likes array.
     */
 ...
 * @descp give an unlike to a post
 * @access Private
 */
...
router.put('/unlike/:post_id', auth, async (req, res) => {
  try {
    ...
    const removeUserIndex = post.likes
...
router.delete('/:post_id/:comnt_id', auth, async (req, res) => {
  try {
    ...
    let comment = post.comments.find(
      comment => comment.id.toString() === req.params.comnt_id
    );
    if (!comment) {
    ...
    let comntIndex = post.comments
      .map(comnt => comnt.id.toString())
